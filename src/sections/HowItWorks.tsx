    ...
    <section className="py-24 px-6 bg-black text-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
          {STEPS.map((s, i) => (
            <FadeIn key={s.step} delay={i * 120} className="h-full">
              <div className="h-full border-2 border-white rounded-sm p-5 sketch shadow-[3px_3px_0_0_rgba(255,255,255,0.4)]">
